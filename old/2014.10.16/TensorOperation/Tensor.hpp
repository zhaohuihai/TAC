...
{
	*this = Tensor(x0.dim(), x1.dim(), x2.dim()) ;
...
{
	*this = Tensor(x0.dim(), x1.dim(), x2.dim(), x3.dim()) ;
...
{
	*this = Tensor(x0.dim(), x1.dim(), x2.dim(), x3.dim(), x4.dim()) ;
...
Tensor<C>::Tensor(const Index& x0, const Index& x1, const Index& x2, const Index& x3, const Index& x4,
									const Index& x5)
{
	*this = Tensor(x0.dim(), x1.dim(), x2.dim(), x3.dim(), x4.dim(), x5.dim()) ;
...
{
	*this = Tensor(x0.dim(), x1.dim(), x2.dim(), x3.dim(), x4.dim(), x5.dim(), x6.dim()) ;
...
{
	*this = Tensor(x0.dim(), x1.dim(), x2.dim(), x3.dim(), x4.dim(), x5.dim(), x6.dim(), x7.dim()) ;
...
//	std::cout << "R = " << R << std::endl ;
	...
	{
		std::cout << "Tensor<C>::putIndex error: number of Index and tensor rank mismatch." << std::endl ;
		exit(0) ;
	}
...
int reNonSymEig(Tensor<double> A, Tensor<double> &Wr, Tensor<double> &Wi, Tensor<double> &Vl, Tensor<double> &Vr)
{
	...
	int n = A.dimension(0) ; // The order of the matrix A (n �����ゆ�烽��锟� 0)
